...
class Env_Resource_Fee(BaseModel, BaseModelMixin):
    ...
    internet_ip = Column(String(512), default="", nullable=False, info={"name": u"默认互联网IP选项", "unit": u"元"})
    internet_ip_ssl = Column(Float, default=0.00, nullable=False, info={"name": u"默认是否需要SSL卸载费用", "unit": u"元"})
...
class Env_Resource_Value(BaseModel, BaseModelMixin):
    ...
    env_id = Column(Integer, ForeignKey('env_info.id', ondelete="CASCADE"), nullable=False, default=0)
    computer = Column(Integer, default=0, nullable=False, info={"name": u"默认云主机数量", "unit": u"个"})
    cpu = Column(Integer, default=0, nullable=False, info={"name": u"默认CPU数量", "unit": u"个"})
    memory = Column(Integer, default=0, nullable=False, info={"name": u"默认内存容量", "unit": u"GB"})
    disk = Column(Integer, default=0, nullable=False, info={"name": u"默认云磁盘数量", "unit": u"个"})
    disk_backup = Column(Integer, default=0, nullable=False, info={"name": u"默认云磁盘备份数量", "unit": u"个"})
    out_ip = Column(Integer, default=0, nullable=False, info={"name": u"默认外部IP", "unit": u"个"})
    snapshot = Column(Integer, default=0, nullable=False, info={"name": u"默认快照数量", "unit": u"个"})
    loadbalance = Column(Integer, default=0, nullable=False, info={"name": u"默认负载均衡数量", "unit": u"个"})
    internet_ip = Column(Integer, default=0, nullable=False, info={"name": u"默认互联网IP选项"})
    internet_ip_ssl = Column(Integer, default=0, nullable=False, info={"name": u"默认是否需要SSL卸载"})
