...
CREATE TABLE `pro_event_detail` (
    `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增ID',
    `event_id` INT(11) NOT NULL DEFAULT '0' COMMENT '所属项目',
    `content` VARCHAR(1024) NOT NULL DEFAULT '' COMMENT '事件内容/受理回复内容',
    `user_id` INT(11) NOT NULL DEFAULT '0' COMMENT '用户ID',
    `checker_id` INT(11) NOT NULL DEFAULT '0' COMMENT '审核者ID',
    `create_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
...
CREATE TABLE `pro_balance_members` (
    `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增ID',
    `pro_balance_id` INT(11) NOT NULL DEFAULT '0' COMMENT '所属项目',
    `ip` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '成员IP',
    `port` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '成员端口',
    `create_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
    `update_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`)
)
...
CREATE TABLE `pro_resource_apply` (
    ...
    `disk_amount` INT(11) NOT NULL DEFAULT '0' COMMENT '总磁盘容量',
    ...
    `internet_ip` INT(11) NOT NULL DEFAULT '0' COMMENT '是否需要发布互联网服务',
    `bandwidth` INT(11) NOT NULL DEFAULT '0' COMMENT '互联网带宽',
...
CREATE TABLE `env_resource_fee` (
    ...
    `computer` float(11, 2) NOT NULL DEFAULT '0' COMMENT '云主机单价费用',
    `cpu` float(11, 2) NOT NULL DEFAULT '0' COMMENT 'CPU单价费用',
    `memory` float(11, 2) NOT NULL DEFAULT '0' COMMENT '内存单价费用',
    `disk` float(11, 2) NOT NULL DEFAULT '0' COMMENT '云磁盘单价费用',
    `disk_amount` float(11, 2) NOT NULL DEFAULT '0' COMMENT '合计备份总容量单价费用',
    `disk_backup` float(11, 2) NOT NULL DEFAULT '0' COMMENT '云磁盘备份单价费用',
    `disk_backup_amount` float(11, 2) NOT NULL DEFAULT '0' COMMENT '云磁盘备份单价费用',
    `out_ip` float(11, 2) NOT NULL DEFAULT '0' COMMENT '外部IP单价费用',
    `snapshot` float(11, 2) NOT NULL DEFAULT '0' COMMENT '快照单价费用',
    `loadbalance` float(11, 2) NOT NULL DEFAULT '0' COMMENT '应用负载均衡单价费用',
    `internet_ip` VARCHAR(512) NOT NULL DEFAULT '' COMMENT '互联网IP类型费用（JSON）',
    `internet_ip_ssl` float(11, 2) NOT NULL DEFAULT '0' COMMENT '互联网IP是否需要SSL卸载',
    `create_time` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
    `update_time` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (`id`),
    KEY `env_id` (`env_id`),
...
CREATE TABLE `env_resource_value` (
    ...
    `disk_amount` INT(11) NOT NULL DEFAULT '0' COMMENT '总磁盘容量默认推荐值',
    `disk_backup` INT(11) NOT NULL DEFAULT '0' COMMENT '云磁盘备份默认推荐值',
    `disk_backup_amount` INT(11) NOT NULL DEFAULT '0' COMMENT '云磁盘备份默认推荐值',
